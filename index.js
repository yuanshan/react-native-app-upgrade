...
const androidVersionName = RNUpgrade.versionName;
const androidVersionCode = RNUpgrade.versionCode;
...
* @param version  本地版本
*/
async function checkUpdate4IOS(appId, version) {
  if (!ANDROID_PLATFORM) {
      try {
